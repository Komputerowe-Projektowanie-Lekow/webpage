...
const I18N = {
  en: {
    ...
    'nav.platform':'Platform','nav.research':'Research',
    'hero.h1':'Auditable compound prioritization against <em>Gram-negative</em> bacteria, guided by molecular evidence and biological constraints.',
    ...
    'cta.join':'Join the team','cta.pipeline':'See pipeline','cta.platform':'Explore the platform','cta.contact':'Start a collaboration',
    'facts.generated':'Records ranked by score v2','facts.valid':'Compounds in the analysed library','facts.pass':'score v2 ROC AUC (1,003-record cohort)',
    ...
    'pipe.kicker':'PROTO-NOOS','pipe.title':'Eight stages from SMILES to systems biology.',
    'pipe.intro':'Explicit orchestration of open-source tools with versioned data contracts: from molecule generation (REINVENT4), through permeability and efflux, target-engagement kinetics and structure (Boltz-2), to dynamics (GROMACS), systems biology (COBRApy / iML1515) and scoring. Click a stage to open its page.',
    'pipe.chart':'Pipeline topology · layout:','pipe.details':'Full platform documentation',
    'pipe.title2':'Eight stages, explicit data contracts.',
